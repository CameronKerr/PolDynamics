################################################################
# Figure 4d - Heatmap for the prejudice-to-objectivity ratio q #
################################################################

## INSTRUCTIONS ##
# Run this script to load in the required functions 'gen_fig4d'
# Running this function with the appropriate parameters will regenerate the associated heatmaps from Fig4d
